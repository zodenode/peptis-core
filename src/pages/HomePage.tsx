...
export function HomePage() {
  return (
    <main id="top">
      ...
      <section className="section guides-band" id="guides">
        <div className="section-inner">
          <div className="section-head">
            <p className="eyebrow">Guides</p>
            <h2>Editorial resources before you start</h2>
            <p>
              Compliance-minded explainers on cash-pay metabolic care and how to
              evaluate an online provider.
            </p>
          </div>
