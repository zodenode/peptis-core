...
export const landingVariants: Record<LandingVariantId, LandingVariant> = {
  strength: {
    ...
    offerHeadline: 'Get the summary and starter plan now. Get box updates if you want them.',
    offerBody:
      'The continuity check and two-day strength plan are free. Join the Lean Mass box launch list. Target price: $59/month. Clinical services are not offered.',
  ...
  box: {
    ...
    lead: 'Complete protein, creatine, electrolytes and foundational micronutrients. Get box launch updates. Target price: $59/month. The two-day strength plan is free today.',
    ctaLabel: 'Get box launch updates',
    ctaTo: '/box-updates',
    micro: 'Supplements are not medicines and do not treat medication side effects.',
    stickyTitle: 'Lean Mass nutrition box',
    stickyNote: 'Target $59/mo. Launch date to be confirmed.',
    ...
    offerHeadline: 'Four everyday nutrition essentials, in one planned box.',
    offerBody:
      'We are confirming the products, servings and shipping date. Join the list to see the final contents and price before you buy.',
    pricingLeft: 'today for plan and updates',
    pricingMid: 'intended Lean Mass box',
    pricingRight: 'nothing ships today',
    pricingNote:
      'The current target is $59/month. Joining the list creates no order or price guarantee.',
  },
  plan: {
    id: 'plan',
    path: '/go/plan',
    ...
    offerHeadline: 'The plan is free. Get box updates if you want them.',
    offerBody:
  ...
  start: {
    ...
    headline: 'See what the scale missed about your strength',
    lead: 'Eight questions. After the first two we save your summary email. Written priorities, a two-day strength plan, and evidence essays. Get launch updates for the planned $59/month box.',
    ctaLabel: 'Get my free summary',
    ctaTo: '/quiz',
    ...
    closerBody: 'Written priorities and the two-day plan. Get box launch updates if you want them.',
    showHeroPrompts: false,
    showLeadCapture: false,
    offerEyebrow: 'Free check first',
    offerHeadline: 'Start with the summary. Get box updates if you want them.',
    offerBody: 'The check and plan are free. Join the box launch list with no payment details.',
    pricingLeft: 'today for summary and plan',
    pricingMid: 'founding box $59/mo',
    pricingRight: 'no payment details',
  ...
  ad: {
    ...
    eyebrow: 'Ad landing',
    headline: 'See what the scale missed about your strength',
    lead: 'Eight questions. After the first two we save your summary email. Written priorities, a two-day strength plan, and evidence essays. Get launch updates for the planned $59/month box. About 3 minutes.',
    ctaLabel: 'Get my free summary',
    ctaTo: '/quiz',
    micro: 'Education only. The nutrition box is coming later. Clinical services are not offered.',
    stickyTitle: 'Free continuity check',
    stickyNote: '3 minutes. $0. No card.',
    closerEyebrow: 'Free continuity check',
    closerHeadline: 'Start the eight questions',
    ...
    offerHeadline: 'Your check, plan, reading and box updates',
